...
def reward_process(end_dist, history_dist, flash_used=False, d_before=None, d_after=None):
    # step reward
    # 步数奖励
    step_reward = -0.001
    ...
    total = step_reward + end_reward + dist_reward + flash_cost + flash_gain + flash_fail
